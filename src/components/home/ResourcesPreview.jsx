  ...
  return (
    <section className="py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal>
          <SectionHeader
            eyebrow={content.resources_eyebrow || "Insights & Resources"}
            title={content.resources_title || "Insights & Resources"}
            subtitle={content.resources_subtitle || "Practical guides on Google Ads, Meta Ads, conversion tracking, GA4, and growth strategy — written for marketers and business owners who want to make better decisions."}
          />
        </Reveal>
        ...
        <Reveal className="mt-12 text-center">
          <CTAButton to="/resources" variant="dark" size="lg">
            {content.resources_cta || "Explore All Resources"}
          </CTAButton>
        </Reveal>
      </div>
    </section>
